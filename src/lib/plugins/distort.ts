...
import { PLUGIN_API, type Plugin, type PluginHost } from './contract';
...
export const distortPlugin: Plugin = {
  id: 'distort',
  api: PLUGIN_API,
  tool: {
    icon: 'distort',
    ...
    /**
     * Everything here is measured on the reference's own 1280-wide canvas: the
     * strength, and the every-fifth-pixel throttle (`~~x % 5`). Counting
